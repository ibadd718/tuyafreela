  ...
  return (
    <div>
      ...
      <div className="bg-white">
        <div id="third-container" className="w-full bg-white py-2 mx-auto px-4 relative z-20 lg:top-40 sm:top-10 mt-10">
          <div className="relative flex flex-col w-full md:mt-0 px-4 z-10">
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 z-0 md:hidden">
              <img src={Hero2} alt="Hero Image" className="w-full h-full object-cover" />
            </div>
            ...
            <div id="hero-div" className="absolute right-0 top-1/2 transform -translate-y-1/2 hidden xl:block z-0">
              <div className="relative">
                <img id="hero-Img" className="hero-image w-full h-full object-cover" src={Hero2} alt="Hero Image" />
      ...
      <div className="" >
        ...
        <div className="bg-white w-[91%] relative py-20 px-10 mx-auto">
          ...
          <Carousel autoPlay="true" axis="vertical" verticalSwipe="standard" showIndicators="false" interval="2000" infiniteLoop="true" showThumbs="false" >
