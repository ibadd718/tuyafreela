  ...
  return (
    <div>
      ...
      <div className="bg-white">
        <div
          id="third-container"
          className="w-full bg-white py-2 mx-auto  relative z-20 md:top-10 sm:top-10 lg:top-36 mt-10"
        >
            ...
            >
              <div className="relative">
                <img
                  ...
                  alt="Hero Image"
                />
                <div className="absolute ml-[45%] inset-0 mt-[-5px]  bg-gradient-to-l from-transparent to-white w-[50%]"></div>
              </div>
            </div>
          </div>
